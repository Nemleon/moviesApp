...
# ЗАПУСК ПРИЛОЖЕНИЯ
#
#   Скачать дамп бд (находится в корневой папке, название db_dump)
#   Запустить локальный сервер и БД
#   Создайть БД с любым названием, тип "InnoDB", кодировка "utf8_general_ci"
#   Импортировать таблицы из дампа в созданную БД
